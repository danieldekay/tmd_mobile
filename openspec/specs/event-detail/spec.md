...
The app SHALL provide a detail page for each event with the most important public TMD4 event information.
...
- THEN each DJ name is a tappable link navigating to the DJ detail

### Scenario: Event detail links to event series

- GIVEN the event belongs to a series
- WHEN the event detail page renders
- THEN the series name is a tappable link navigating to the series detail
